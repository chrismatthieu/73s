module ActionView::Helpers::FormOptionsHelper
  ...
  IRELAND_STATES=["Antrim","Armagh","Carlow","Cavan","Cork","Clare","Derry","Donegal","Down","Dublin","Fermanagh","Galway","Kerry","Kildare","Kilkenny","Laois","Leitrim","Limerick","Longford","Louth","Mayo","Meath","Monaghan","Offaly","Roscommon","Sligo","Tipperary","Tyrone","Waterford","Westmeath","Wexford","Wicklow"] unless const_defined?("IRELAND_STATES")
...
#  US_POSTAL_CODES_STATES = [’AK’,'AL’,'AR’,'AS’,'AZ’,'CA’,'CO’,'CT’,'DC’,'DE’,'FL’,'FM’,'GA’,'GU’,'HI’,'IA’,'ID’,'IL’,'IN’,'KS’,'KY’,'LA’,'MA’,'MD’,'ME’,'MH’,'MI’,'MN’,'MO’,'MP’,'MS’,'MT’,'NC’,'ND’,'NE’,'NH’,'NJ’,'NM’,'NV’,'NY’,'OH’,'OK’,'OR’,'PA’,'PR’,'PW’,'RI’,'SC’,'SD’,'TN’,'TX’,'UT’,'VA’,'VI’,'VT’,'WA’,'WI’,'WV’,'WY’] unless const_defined?("US_POSTAL_CODES_STATES")
